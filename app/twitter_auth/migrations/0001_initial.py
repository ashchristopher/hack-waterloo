...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TwitterAuth'
        db.create_table('twitter_auth_twitterauth', (
        ...
        db.send_create_signal('twitter_auth', ['TwitterAuth'])


    def backwards(self, orm):
        
        # Deleting model 'TwitterAuth'
        db.delete_table('twitter_auth_twitterauth')
