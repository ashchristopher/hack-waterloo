...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_profile', (
            ...
            ('screen_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ...
        db.create_unique('profiles_profile_following', ['profile_id', 'user_id'])
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'following': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'followers'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile_image_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'screen_name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
